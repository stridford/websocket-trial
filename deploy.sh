...
scp -i "microec2test.pem" execute_commands_on_ec2.sh ec2-user@ec2-13-211-168-16.ap-southeast-2.compute.amazonaws.com:/home/ec2-user
echo "Copied latest 'execute_commands_on_ec2.sh' file from local machine to ec2 instance"

scp -i "microec2test.pem" target/websockettrial-0.0.1-SNAPSHOT.jar ec2-user@ec2-13-211-168-16.ap-southeast-2.compute.amazonaws.com:/home/ec2-user
...
ssh -i "microec2test.pem" ec2-user@ec2-13-211-168-16.ap-southeast-2.compute.amazonaws.com ./execute_commands_on_ec2.sh